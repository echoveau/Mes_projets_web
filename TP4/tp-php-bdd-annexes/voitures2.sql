...
--
-- Client :  localhost
-- Généré le :  Jeu 07 Février 2019 à 13:57
...
(1011, 'CHOVEAU', 'Etienne', '31 rue de la rue', 'Briollay', 49125);
...
--
ALTER TABLE `proprietaire`
  MODIFY `id_pers` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1012;
